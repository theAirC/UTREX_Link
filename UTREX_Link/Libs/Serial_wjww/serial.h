...
struct Timeout {
     ...
     *
     * \param timeout A long that defines the time in milliseconds until a timeout occurs after a call to read or write is made.
     *
     * \return Timeout struct that represents this simple timeout provided.
     */
    static Timeout simpleTimeout(u32 timeout) {
        return Timeout(max(u32), timeout, 0, timeout, 0);
    }
    ...
    Timeout (u32 inter_byte_timeout = 0,
                     u32 read_timeout_constant = 0,
                     u32 read_timeout_multiplier = 0,
                     u32 write_timeout_constant = 0,
                     u32 write_timeout_multiplier = 0)
...
public:
    ...
    void setTimeout (u32 inter_byte_timeout, u32 read_timeout_constant,
